...
import com.tovalue.me.model.datingJourney.Plans

class DatingJourneyOurCalenderAdapter internal constructor(private val context: Context) : BaseExpandableListAdapter() {
    ...
    override fun getChild(listPosition: Int, expandedListPosition: Int): Plans {
        return planDetailList[groupTitleList[listPosition]]?.get(expandedListPosition)?.plans?.first() ?: Plans()
    }
    ...
    override fun getChildView(
        ...
        convertView.titleTv.setTextColor(
            Color.parseColor(expandedList.colorCode!!)
        )
