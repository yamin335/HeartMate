package com.tovalue.me.customviews.calendarview.widget
...
import com.tovalue.me.customviews.calendarview.data.CalendarAdapter
import com.tovalue.me.customviews.calendarview.data.Day
import com.tovalue.me.customviews.calendarview.data.Event
import com.tovalue.me.customviews.calendarview.view.BounceAnimator
import com.tovalue.me.customviews.calendarview.view.ExpandIconView
...
open class CollapsibleCalendar : UICalendar, View.OnClickListener {
    ...
    override fun reload() {
        mAdapter?.let { mAdapter ->
            ...
            for (i in 0..6) {
                ...
                txtDayOfWeek.setText(DateFormatSymbols().shortWeekdays[(i + firstDayOfWeek) % 7 + 1])
    ...
    private fun setAdapter(adapter: CalendarAdapter) {
        mAdapter = adapter
